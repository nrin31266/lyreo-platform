...
### 11.1 Pull Request Review Skill (`lyreo-pr-review`)

For reviewing GitHub PRs, use the project-local skill `.agents/skills/lyreo-pr-review`:
- **Invocation**: `Review <PR_URL>` (triggers `lyreo-pr-review`).
...
- **Review artifact**: Exported outside git to `${XDG_STATE_HOME:-$HOME/.local/state}/lyreo-pr-review/<owner>-<repo>/pr-<number>-review.md`.
